...
@section('container')
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">New Portofolio</h1>
    </div>

    <div class="col-md-8">
        <form method="post" action="/dashboard/portofolios" class="mb-4" enctype="multipart/form-data">
            @csrf
            <div class="mb-3">
            ...
            <button type="submit" class="btn btn-primary">Add Portofolio</button>
        </form>
