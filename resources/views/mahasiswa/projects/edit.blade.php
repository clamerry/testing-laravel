...
@section('page_content')
    ...
    <div class="col-md-8">
        <form method="post" action="/mahasiswa/projects/{{ $projects->id }}" class="mb-4"
            ...
            <div class="mb-3">
                ...
                <input type="date" class="form-control @error('description') is-invalid @enderror" id="description" name="description" required
